 ...
 <script src="/bootstrap/bjs/sb-admin-2.min.js"></script>

 <!-- Page level plugins -->
 <script src="/bootstrap/vendor/chart.js/Chart.min.js"></script>

 <!-- Page level custom scripts -->
 <script src="/bootstrap/bjs/demo/chart-area-demo.js"></script>
 <script src="/bootstrap/bjs/demo/chart-pie-demo.js"></script>
 <!-- jQuery -->
