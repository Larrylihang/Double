...
<body class="background-img bg-gradient-primary">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="test col-xl-6 col-lg-12 col-md-9">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="/admin/homepage">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class=" verifyCode form-control form-control-user"
                                                id="vcode" placeholder="Verify Code" name="code">
                                            <span><i class=""></i></span>
